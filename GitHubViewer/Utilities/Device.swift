...
public enum Device {
  ...
  public static func realDevice(from device: Device) -> Device {
    ...
    public static var isSimulator: Bool {
        return Device() == .simulator(Device().realDevice)
    }
    
  /// Returns diagonal screen length in inches from real device
    public static var realDiagonal: Double {
        return Device.realDevice(from: Device()).diagonal
    }
