...
public extension UITableView {
    ...
    func dequeueReusableHeader<H: UITableViewHeaderFooterView>() -> H {
...
public extension UITableView {
    ...
    func dequeueCell<T: UITableViewCell>(_ type: T.Type = T.self, withIdentifier reuseIdentifier: String = T.reuseIdentifier, for indexPath: IndexPath) -> T {
