...
extension EmptyView {
    ...
    static func createEmptyIssueComments(offset: CGFloat = 0.0)  -> EmptyView {
        return EmptyView(image: #imageLiteral(resourceName: "OctoCatInClouds"), text: String.EmptyView.emptyIssueComments, offset: offset)
    }
